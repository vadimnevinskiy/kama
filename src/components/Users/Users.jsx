                    ...
                    return (
                        <div key={u.id} className={classes.user}>
                            <div className={classes.userImg}>
                                ...
                                <div>
                                    { u.followed ?
                                        <button className={classes.button + ' ' + classes.redBtn} onClick={() => { props.unfollow(u.id) }} >Unfollow</button> :
                                        <button className={classes.button + ' ' + classes.greenBtn} onClick={() => { props.follow(u.id) }} >Follow</button>
                                    }
                            ...
                            <div className={classes.userInfo}>
                                <div className={classes.userStatus}>
                                    <div><strong>{u.fullname} {u.id}</strong></div>
